...
fn calc(h: usize, w: usize, masu: &Vec<Vec<char>>) -> i32 {
    ...
    let mut dp1 = get_4d_vec(2, h, h, w);
    let mut dp2 = get_4d_vec(2, w, w, h);
                    ...
                    let c2 = if r2 == r1 {
                        ...
                        if c2_yoko >= 0 {
                            while ((c2_yoko + 1) as usize) < w {
                                let r2_next =
                                    yoko_wari(h, &dp2, c1, (c2_yoko + 1) as usize, r1, f);
                    ...
                    let r2 = if c2 == c1 {
                        ...
                        if r2_tate >= 0 {
                            while ((r2_tate + 1) as usize) < h {
                                let c2_next =
                                    tate_wari(w, &dp1, r1, (r2_tate + 1) as usize, c1, f);
...
fn get_4d_vec(s1: usize, s2: usize, s3: usize, s4: usize) -> Vec<Vec<Vec<Vec<i32>>>> {
    ...
    for _i in 0..s1 {
        ...
        for j in 0..s2 {
            //let s3_x = s3 - j;
            //let mut v3: Vec<Vec<i32>> = Vec::with_capacity(s3_x);
